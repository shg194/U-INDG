 ...
 * It is used to represent spatial data in the R-tree index structure.
 */
public class MBR implements Cloneable, Comparable<MBR> {
     ...
     *
     * @param rec The other MBR to be united with this MBR.
     * @return The minimum bounding rectangle containing both MBRs.
     * @throws IllegalArgumentException If the input MBR is null or has a different dimension.
     */
     ...
     *
     * @param rec An array of MBRs to be united.
     * @return The minimum bounding rectangle containing all the MBRs.
     ...
     * If the MBR represents a point (low and high are equal), it returns the coordinates of the point.
    ...
    /**
     * Computes the area of intersection between this MBR and another MBR.
     * If the MBRs do not intersect, returns 0.
     *
     * @param rec The other MBR to compute the intersection area with.
    ...
    /**
     * Checks if this MBR encloses another MBR.
     *
     * @param rec The other MBR to check if it is enclosed by this MBR.
     * @return True if the other MBR is enclosed by this MBR, false otherwise.
     * @throws IllegalArgumentException If the input MBR is null or has a different dimension.
     */
    ...
    /**
     * Compares this MBR with another MBR based on their minimum distance (mindist).
     * Used for sorting MBRs.
     *
     * @param arg0 The other MBR to compare with.
     * @return A negative value if this MBR's mindist is less than the other's,
     *         zero if they are equal, and a positive value if this MBR's mindist is greater.
     */
    @Override
    public int compareTo(MBR arg0) { // Compare 2 rectangles by their mindists
        if (arg0 != null) {
            return Utils.compare(Utils.fromPtoZ(this.low), Utils.fromPtoZ(arg0.low));
        }
        return 0;
    }
    ...
    /**
     * Computes the hash code for this MBR.
     *
     * @return The hash code for this MBR.
     */
    @Override
    public int hashCode() {
